...
## Example LMP Distribution Plot

This plot demonstrates the distribution of LMPs for an example node:

```{r visualize_node_example, fig.cap="LMP Distribution Example Plot", eval = TRUE, echo = FALSE}
# Load the CSV file 
...
sf_node = read.csv(system.file("extdata", "San_Francisco_node_2023.csv", package = "CAISOWrapR"))
visualize_node(sf_node)

```

## Example Seasonal LMP Distribution Plot

This plot demonstrates the distribution of LMPs for an example node:

```{r visualize_node_example_seasonal, fig.cap="SeasonalLMP Distribution Example Plot", eval = TRUE, echo = FALSE}
# Load the CSV file 
# file_path <- system.file("extdata", "San_Francisco_node_2023.csv", package = "CAISOWrapR") 
# example_data <- read.csv(file_path)
...
sf_node = read.csv(system.file("extdata", "San_Francisco_node_2023.csv", package = "CAISOWrapR"))
visualize_node_seasonal(sf_node)

```

## Example Comparison LMP Distribution Plot

This plot demonstrates the distribution of LMPs for an example node:

```{r visualize_node_example_comparison, fig.cap="Comparison LMP Distribution Example Plot", eval = TRUE, echo = FALSE}
# Load the CSV file 
# file_path <- system.file("extdata", "San_Francisco_node_2023.csv", package = "CAISOWrapR") 
# example_data <- read.csv(file_path)
...
sf_node = read.csv(system.file("extdata", "San_Francisco_node_2023.csv", package = "CAISOWrapR"))
la_node = read.csv(system.file("extdata", "Los_Angeles_node_2023.csv", package = "CAISOWrapR"))
compare_lmps_visual_seasonal(sf_node, la_node)

```

## Example Demand and LMP Plot

This plot demonstrates the distribution of LMPs for an example node:

```{r visualize_node_example_demand, fig.cap="Demand and LMP Example Plot", eval = TRUE, echo = FALSE}
# Load the CSV file 
# file_path <- system.file("extdata", "San_Francisco_node_2023.csv", package = "CAISOWrapR") 
# example_data <- read.csv(file_path)
...
sf_node = read.csv(system.file("extdata", "San_Francisco_node_2023.csv", package = "CAISOWrapR"))
visualize_node_demand_without_high_demand_hours(sf_node)
