...
# Project Outputs
- API wrapper for the gridstatus.io API to fetch and clean data of locational marginal prices for California between 2020-2023
- A Shiny App that visualizes the transmission lines and locational data
- Analysis functions for a single instance (15 minute interval) across all nodes, and for an entire node (or comparing nodes) across all instances of a year
