...
#' 
#' @export
compare_congestion_visual = function(df1, df2){
  df1 <- df1 %>%
    mutate(
      interval_start_utc = as.POSIXct(interval_start_utc, format = "%Y-%m-%d %H:%M:%S", tz = "UTC"),
      interval_start_pst = lubridate::with_tz(interval_start_utc, tzone = "America/Los_Angeles"),
...
#' 
#' @export
compare_congestion_visual_seasonal = function(df1, df2){
  df1 <- df1 %>%
    mutate(
      interval_start_utc = as.POSIXct(interval_start_utc, format = "%Y-%m-%d %H:%M:%S", tz = "UTC"),
      interval_start_pst = lubridate::with_tz(interval_start_utc, tzone = "America/Los_Angeles"),
...
#' 
#' @export
compare_losses_visual = function(df1, df2){
  df1 <- df1 %>%
    mutate(
      interval_start_utc = as.POSIXct(interval_start_utc, format = "%Y-%m-%d %H:%M:%S", tz = "UTC"),
      interval_start_pst = lubridate::with_tz(interval_start_utc, tzone = "America/Los_Angeles"),
...
#' 
#' @export
compare_losses_visual_seasonal = function(df1, df2){
  df1 <- df1 %>%
    mutate(
      interval_start_utc = as.POSIXct(interval_start_utc, format = "%Y-%m-%d %H:%M:%S", tz = "UTC"),
      interval_start_pst = lubridate::with_tz(interval_start_utc, tzone = "America/Los_Angeles"),
